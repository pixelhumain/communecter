...
return array(
	...
	"100" => "L'entité n'a aucune informations sur l'adresse.",
	...
	"110" => "Nous n'avons pas trouvé la commune : Vérifier si le code postal et le nom de la commune sont exacts",
	...
	"153" => "L'entité n'a pu être géolocalisée précisément : Repositionnez-la.",
	"154" => "Nous n'avons pas réussi à géolocaliser l'entité: Vérifier l'adresse et Repositionnez-la.",
	...
	"171" => "L'INSEE du fichier et celui retourné par la géolocalisation ne sont pas identiques.",
	"172" => "Le code postal du fichier et celui retourné par la géolocalisation ne sont pas identiques.",
	...
	"207" => "Une personne avec ce nom d'utilisateur existe déjà sur la plateforme.",
	"208" => "Cet organisme n'a pas de type.",
	"209" => "Vous devez remplir un email valide pour le contactPoint.",
	"210" => "Cette personne n'a pas de nom d'utilisateur.",
	"211" => "Ce nom d'utilisateur a été généré automatique à partir du nom de l'utilisateur.",
	"212" => "Le Type \"Groupe\"  a été attribué a cet organisation. Veuilliez changer le type de l'organisation s'il ne correspond pas à ce type.",
