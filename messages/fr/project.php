...
return array(
	...
	"Enter the project's start" => "Entrez le début du projet",
	"Enter the project's end" => "Entrez la fin du projet",
	"Enter the project's licence" => "Entrez la licence du projet",
	"Enter the project's url" => "Entrez l'url du projet",
	...
	"Connect People or Organizations that are part of the project" => "Connectez les personnes et les organisations qui font partie du projet",
	//Chart
	...
	"Your project is updated" => "Votre projet a été mis à jour avec succés",
