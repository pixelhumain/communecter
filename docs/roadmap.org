...
** @Bouboule 
  ...
  *** Notifications
  ...
  [X] View of notification
    [X] Get new model of notification
    [X] Create $or in condition to get old notification 
      [X] Create bash on notify.id in datamigration => ph/communecter/datamigration/UpOldNotifications
    [X] Plug notifification time on updated
    [X] Use unSee && unRead label in notifcation
      [X] Count unsee notification
      [X] Onclick notif, check this notif as read
      [X] Onclick mark all as read, update all notif as read
      [X] Create delete btn
    [X] Bug on lbh load
    *** Wishlist
  ...
  *** Mail
  [ ] Template for use case
    ...
    [2] Generalize someoneAskToBecome with someoneInvitingYou
    [2] someoneValidate invitation or demand to author
    [2] Follow me [Insert new follow if notif is not view]
  [2] Insert daily mail
  ...
  *** Admin Communication
  [2] Creation of news letter 
    [2] Choose scope or theme community
    [2] To all
    [2] See view of newsletter 
  *** Bugs
    [X] Notification
