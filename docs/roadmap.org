...
** @Bouboule 
  ...
  *** Notifications
  ...
  [ ] Commons method called to construct notification
    ...
    [ ] /Invite/ 
      [ ] Generalize invitation as event for organization and project
    [ ] /Confirm/ an invitation to join a element (for moment event)
  ...
  [ ] View of notification
    ...
    [ ] Plug notifification time on updated
  *** Mail
  [ ] Template for use case
    [X] AskToBecomeAdmin, AskToBecomeMember
  [ ] Insert daily mail
  *** Preferences
  ...
  *** News
  [ ] View of like, unlike 
  *** Link
  [ ] Add confirmation if someone link me to orga or projet (as event)
  [ ] Friend relation between persons ?? (community to notify, messaging, see information ??) 
    *** Bug
    [ ] If isPendingAdmin or toBeValidated as member user is consedering as member in right access
