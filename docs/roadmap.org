...
** @Sylvain 
    [ ] bug : gestion des comptes en doublon depuis communEvent (ex : 57cbce3a40bb4e0a0dfb8256 et 57be6caa40bb4eb84ef5aa49 en prod)
      [ ] gestion des comptes en doublons sur la prod : suppression et report
      [ ] pb de case sur l'email avec link.connect
      [ ] pb de case sur l'email au login
      [ ] pb de case sur l'email au register
