...
** @Rapha
  ...
  *** Priority 1
    ...
    [ ] Refactor Element
      ...
      [ ] Le Header qui est dans details et plus grand que dans fil d'actualité,  etc...
      [ ] Bug ajout d'une image de profil
      [ ] Active des btn menu 
      [ ] Améliorer le btn "Communecter-moi", celui du HeaderElement
      [ ] Dans news/index.js : buildTimeLine() ; cette fct continue de s'executer meme si on est sur la page détail de l'élément
      [ ] Le Header est dans details et plus grand que dans fil d'actualité,  etc...
      [ ] Error 404 , pendant la deconnexion
