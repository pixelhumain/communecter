...
** @Bouboule 
  ...
  *** Notifications
  ...
  [ ] Add method to get intelligent Notifications
    ...
    [ ] Update community to notify if one is out of element
  [ ] Commons method called to construct notification
    ...
    [ ] /Join/ for creator of event, member of orga or project
  ...
  [ ] View of notification
    ...
    [ ] Create $or in condition to get old notification
    [X] Plug notifification time on updated
    [ ] Use unSee && unRead label in notifcation
    [ ] Bug on lbh load
  *** Mail
  [ ] Template for use case
    [X] someoneAskToBecome (Admin || Member=
    [ ] Generalize someoneAskToBecome with someoneInvitingYou
  [ ] Insert daily mail
  *** Preferences
