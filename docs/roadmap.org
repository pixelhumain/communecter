...
[ ] POI et Element de base (0.16??)
  ...
  ** @Rapha
    [ ] Modifier l'update des préférence pour permettre l'entrée de openData/openEdition dans l'historique
  ...
  ** @Tib 
    [ ] ajouter un tag avec le surligner + petit menu contextuel 
