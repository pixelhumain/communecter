...
** @Tib 
  ...
  [ ] collections
    ...
    [ ] bugs 
      ...
      [ ] change right click name Remove from fav
      [ ] persisting location, 
      [ ] no crossing between location search and tags
      [ ] Remove from Favorite or a collection
  ...
  [ ] link counter : à chaque fois que je contact qlqun, +1 
  * DDA
