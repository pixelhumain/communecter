...
** @Tango 
    ...
    [ ] Page commune : modif header btn search
** @Sylvain 
  ...
  ** PROD
  ...
  [ ] elements to simple dynform
    ...
    [ ] bugs
      ...
      [ ] delete from location liste after having added
    ...
    [ ] event to organizer, name, type, allday, dates, location btn
      ...
      [ ] simplify add for sub events: [[pré remplir les dates, lieu]]
    ...
    [ ] POI et Element de base : name,desc, url, location,photo
      ...
      [ ] [[ @Tango :: switch on map , show / hide POI, point of parent]]
      ...
      [ ] [[ add photo ]]
      [ ] [[ @Clem :: add POI to news]]
      [X] add text : getUrl, multiple medias , $.each
      [X] unknown attribute passes the the save 
      [X] delete POI
      [X] edit POI
      [ ] [[view POI in modal], pour @Hord Cadre]
        [ ] on pourrait alors creer un poi d'abord et ensuite créer dessus des orga , event ,projet ... 
      [ ] add to favorite
    [ ] debat 
