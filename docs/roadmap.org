...
[ ] fair un mail, special quand invité par l'invitation communEvent 
...
** Pas affecté
  ...
  [ ] Refaire fonctionner la geolocalisation
...
** @Tib 
    [ ] added middle click to notifications
    [ ] finish fromNow method
    [ ] switched QRcodes to full URLs, they can then be parsed
