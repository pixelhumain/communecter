	...
	***/
	...
	SigLoader.getSigPopupContent = function (Sig){ 
		...
		Sig.getPopupCitoyen = function(citoyen){
			
			var popupContent = "";
			if(citoyen['thumb_path'] != null)   
			popupContent += "<div class='popup-info-profil-thumb-lbl'><img src='" + citoyen['thumb_path'] + "' height=100 class='popup-info-profil-thumb'></div>";
			else
			popupContent += "<div class='popup-info-profil-thumb-lbl'><img src='"+assetPath+"/images/thumb/default.png' width=100 class='popup-info-profil-thumb'></div>";
