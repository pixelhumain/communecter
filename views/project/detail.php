...
$(".moduleLabel").html("<i class='fa fa-lightbulb-o'></i> <?php echo Yii::t('common','PROJECT') ?> : <?php echo $project["name"] ?>  <a href='javascript:showMap()' id='btn-center-city'><i class='fa fa-map-marker'></i></a>");
