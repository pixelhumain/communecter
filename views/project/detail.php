...
jQuery(document).ready(function() {
	contextData = {
		...
		odesc : "Projet : <?php echo (@$project["shortDescription"]) ? addslashes(strip_tags(json_encode(@$project["shortDescription"]))) : '' ?> <?php echo (@$project["address"]["streetAddress"]) ? @$project["address"]["streetAddress"] : '' ?> "
	}; 
