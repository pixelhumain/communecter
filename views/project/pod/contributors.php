	...
	<div class="panel panel-white">
		<div class="panel-heading border-light">
			...
			<div class="panel-tools">
				<?php if ($admin){ ?>
				<a href="#newContributors" class="new-contributor btn btn-xs btn-light-blue tooltips" data-placement="top" data-original-title="<?php echo Yii::t("project","Connect People or Organizations that are part of the project",null,Yii::app()->controller->module->id) ?>" <?php if (isset($isDetailView)){ ?> onclick="showAjaxPanel( baseUrl+'/'+moduleId+'/project/addcontributorsv?isNotSV=1&projectId=<?php echo (string)$project["_id"];?>&projectName=<?php echo $project["name"] ?>', 'ADD CONTRIBUTORS','users' )" <?php } ?>><i class="fa fa-plus"></i></a>
				<?php } ?>
