...
<div class="panel-heading border-light center text-dark partition-white radius-10">
    <span class=" text-red homestead tpl_title"> Documentations et Slideshow</span>
    <br/>
    <span class="tpl_shortDesc">Comprendre les principes et ...
     </span>
</div>
		        ...
		        <div class="panel panel-white user-list ">
					...
					<div class="panel-body">
				        ...
				        <ul class="points">
				        	...
				        	<li><i class='fa fa-arrow-right'></i> <a href="javascript:loadByHash('#default.view.page.events.dir.docs');">évènnement</a></li>
				        	<li><i class='fa fa-arrow-right'></i> Projet</li>
				        </ul>
				    </div>
				</div>
			</div>
