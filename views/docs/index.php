...
<div class="panel-heading border-light center text-dark partition-white radius-10">
    ...
    <br/>
    <span class="tpl_shortDesc"> Tout ce qu'il faut savoir sur le réseau Communecter ...</span>
    <br/>    
    <span class=" text-orange"><i class="fa fa-battery-2"></i> Rédaction en cours</span><br/>
		        ...
		        <div class="panel panel-white user-list ">
					<div class="panel-heading border-light">
						<h4 class="panel-title homestead text-red pull-left">
							<i class="fa fa-cubes"></i> Les 4 Elements	
						</h4>
						<div class="btn-group pull-right">
							<a class="btn btn-default btn-sm bold" href="javascript:loadByHash('#default.view.page.elements.dir.docs');"><i class="fa fa-eye"></i> Lire</a>
						</div>
					</div> 
					<div class="panel-body">
						<img src="<?php echo $this->module->assetsUrl; ?>/images/docs/elements/index.png" class="col-sm-12 img-responsive ">
				    </div>
				</div>
		</div>
        ...
        <div class="col-sm-12" style="margin-top:30px;margin-bottom:30px; " >
			...
			<div class="col-sm-12 ">
		        <div class="panel panel-white user-list ">
					...
					<div class="panel-body">
						<b>Pour être connecté</b> à tout ce(ux) qui bouge(nt) autour de vous, et participer à l'activité de votre territoire :
						<br/>
				        <ul class="points">
				        	<li><i class='fa fa-arrow-right'></i> Découvrir ou redécouvrir les alternatives locales </li>
				        	<li><i class='fa fa-arrow-right'></i> Discuter en ligne, avec vos voisins</li>
				        	<li><i class='fa fa-arrow-right'></i> Participer au conseil citoyen</li>
				        	<li><i class='fa fa-arrow-right'></i> Faire connaître vos projets, et trouver du soutient</li>
				        	<li><i class='fa fa-arrow-right'></i> Devenir un acteur responsable de votre territoire</li>
				        </ul>
				    </div>
				</div>
			</div>
		...
		<div class="col-sm-12">
			<div class="col-sm-12">
		        <div class="panel panel-white user-list ">
					...
					<div class="panel-body">
			        	<b>Communecter</b> c'est aussi plein de gros mots qu'on essaie de vous expliquer simplement :
						<br/>
				        <ul class="points">
			...
			<div class="col-sm-12">
		        <div class="panel panel-white user-list ">
					...
					<div class="panel-body">
						<b>Communecter</b> ne s'est pas construit en un jour !
						<br/>
				        <ul class="points">
