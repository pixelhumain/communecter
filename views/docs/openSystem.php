...
<div class="panel-heading border-light center text-dark partition-white radius-10">
    <span class=" text-red homestead tpl_title"> Open System</span>
    <br/>
...
<div class="col-sm-12 ">
    ...
    <div class="panel panel-white ">
        ...
        <img src="<?php echo $this->module->assetsUrl; ?>/images/docs/openSystem.png"" class="col-sm-12 img-responsive ">
		        ...
		        <div class="panel panel-white user-list ">
					...
					<div class="panel-body">
				        <ul class="points">
				        	...
				        	<li><i class='fa fa-arrow-right'></i> <a href="https://github.com/pixelhumain/buildingCommons/blob/master/codeSocialOpenSystem.md" target="_blank">Sur Github</a></li>
				        </ul>
				    </div>
				</div>
			</div>
	    ...
	    <div class="col-md-10 col-sm-offset-1 codeSocial" >
	    	
	    	<h1 class="center text-red homestead">Code social d’un "OpenSystem"</h1>
			<h2>“Écosystème ouvert”</h2>
			...
			<ul>
				<li>De travailler ensemble efficacement</li>
				<li>D’interagir de manière fluide (Système d’information ouvert)</li>
				<li>De collaborer de manière agile et décentralisée (stigmergie, LEAN, AGILE)</li>
				<li>De partager nos offres et opportunités (Catalogue contributif)</li>
				<li>De répartir équitablement la valeur collectivement générée (Matrices de richesses, Revenu de base)</li>
				<li>De mélanger nos offres pour innover en continu</li>
				<li>De dépasser la rentabilité pour aller vers le plaisir, le partage et la créativité</li>
				<li>De créer un système autonome et résilient à la crise économique (de la ZAD à la ZAN : Zone Autonome Numérique)</li>
				<li>De développer l’intelligence collective au service de l’innovation et des bien communs</li>
				<li>De ne jamais oublier les contextes déconnectés (solutions déconnectées)</li>
				<li>De garder une place importante à la chance, par tirage au sort</li>
				<li>Que toutes activités et l’innovation de l’écosystème passent par le partage et des décisions démocratique (par exemple sur Loomio)</li>
				<li>D’innover par notre capacité d’ouverture et de partage</li>
				<li>Rejoindre l’écosystème, c’est souscrire à l’idée qu’on peut créer ensemble un système libre, infiniment duplicable, plus intelligent et efficient, valorisant diverses techniques et technologies du moment pour éliminer les contraintes, réduire l'impact, remplacer les système pyramidaux et descendants par des organismes aux fonctionnements équilibrés, fluides, inversés et libres.</li>
			</ul>
			...
			Dans le même esprit, les membres de l’écosystème s’engagent à veiller à une interopérabilité technique et sémantique, notamment en utilisant autant que possible du vocabulaire et un langage compréhensible par tous, tant au niveau des développements informatiques que des échanges humains. Les missions

			<h3>Missions internes</h3>
			...
			<h3>Imaginaire, sources d'inspiration</h3>
			...
			<h2>Faisceau de richesses</h2>

			<h3>Matrices de richesse</h3>
