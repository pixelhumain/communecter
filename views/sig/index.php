...
{ 	
	...
	***/				
	function showCitoyensClusters(mapClusters, origine, listIdElementMap){ 
		...
		$('#btn_reload_map').html(
			'<center><img src="<?php echo $this->module->assetsUrl; ?>/images/ajax-loader.gif" height=22></center>');
	...
	***/
	function initMap(origine, myInfos, myPosition){	
		...
		//initialisation du bouton rouge, trouillomètre à 0, et 1 et 2 et 3 zéro, France Brésil très bien joué !
