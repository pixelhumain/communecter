<div id="panel_organisations" class="tab-pane fade">
	<div class="row">
		<div class="col-md-12 padding-20 ">
			<a href="javascript:;" onclick="openSubView('Add an Organisation', '/communecter/organization/addorganizationform',null)" class="btn btn-xs btn-light-blue tooltips pull-right" data-placement="top" data-original-title="Edit"><i class="fa fa-plus"></i> Add an Organization</a>
		...
		<tbody>
			...
			<tr id="<?php echo Organization::COLLECTION.(string)$e["_id"];?>">
				...
				<div class="visible-md visible-lg hidden-sm hidden-xs">
					...
					<a href="javascript:;" class="disconnectBtn btn btn-red tooltips " data-linkType="<?php if(isset($e["linkType"]))echo $e["linkType"]?>"  data-type="<?php echo Organization::COLLECTION ?>" data-id="<?php echo (string)$e["_id"];?>" data-name="<?php echo (string)$e["name"];?>" data-placement="top" data-original-title="Remove Knows relation" ><i class=" disconnectBtnIcon fa fa-unlink"></i></a>
				</div>
				</td>
			</tr>
			<?php
