		...
		<tbody>
			...
			<tr id="project<?php echo (string)$e["_id"];?>">
				...
				<div class="visible-md visible-lg hidden-sm hidden-xs">
					...
					<a href="<?php echo Yii::app()->createUrl('/'.$this->module->id.'/project/view/id/'.$e["_id"]);?>" class="btn btn-light-blue tooltips " data-placement="top" data-original-title="Edit"><i class="fa fa-pencil-square-o"></i></a>
