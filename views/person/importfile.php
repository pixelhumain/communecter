					...
					<form method="POST" action="<?php echo Yii::app()->getRequest()->getBaseUrl(true).'/communecter/person/importmail/';?>" id="shareForm" >
						<div class="form-group col-md-12">
							<div class="col-md-4 col-md-offset-2">
								<input type="file" id="fileemail" name="fileemail" accept=".csv">
				        	</div>
				        	<a href="#" class="btn btn-primary col-md-2 col-md-offset-1" id="submitAfficher">Afficher</a>
						</div>	
	...
	$("#submitAfficher").off().on('click', function()
  	{
	    ...
	    entree = document.getElementById('fileemail');
	    
	    if (!entree.files[0]) 
	    {
	        toastr.error("S’il vous plaît sélectionnez un fichier avant de cliquer sur «Afficher».");
	    } 
	    else 
	    {
	        ...
	        fr.onload = function () 
	        {
	        	var chaine = fr.result;
	        	arraymail = chaine.split('\n');   
	        };
	        //$.csv.toArray(entree.files[0]);
	        
	        alert("Sélectionnez vos contacts");
