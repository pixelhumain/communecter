    ...
    <div class="panel core-box small">
      ...
      <div class="panel-body no-padding">
        ...
        <div class="padding-20 core-content">
          <h3 class="title block no-margin">150 Citoyens</h3>
        </div>
      </div>
    </div>
  </div>
  <div class="col-md-6 col-lg-2 col-sm-6">
    <div class="panel core-box small">
      ...
      <div class="panel-body no-padding">
        ...
        <div class="padding-20 core-content">
          <h3 class="title block no-margin">99 Associations</h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6 col-lg-2 col-sm-6">
    <div class="panel core-box small">
      ...
      <div class="panel-body no-padding">
        ...
        <div class="padding-20 core-content">
          <h3 class="title block no-margin">15 Entreprises</h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6 col-lg-2 col-sm-6">
    <div class="panel core-box small">
      ...
      <div class="panel-body no-padding">
        ...
        <div class="padding-20 core-content">
          <h3 class="title block no-margin">Collectivité</h3>
        </div>
      </div>
    </div>
  </div>
