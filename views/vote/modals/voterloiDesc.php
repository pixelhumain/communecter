...
<div class="modal fade" id="voterloiDescForm" tabindex="-1" role="dialog" aria-labelledby="voterloiDescFormLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="voterloiDescFormLabel" >Voter les propositions </h3>
      </div>
...
<br/>
Vous pouvez soit:<br/>
<a class="btn voteUp" href="javascript:;"><i class='fa fa-thumbs-up'></i></a> Pour : 
Si vous êtes d'accord avec la proposition.<br/>
<br/>
...
Si vous êtes en désaccord avec la proposition.<br/>
        </p>
