...
<div class="hover-info col-md-7 col-md-offset-3 col-sm-6 col-sm-offset-5 hidden-xs panel-white padding-20">
	...
	<div class="explainAgenda explain hide">
		...
		<ul>
			...
			<li><i class="fa fa-angle-right"></i> Les événements ça se partage avec plaisir.</li>
			<li class="text-red"><i class="fa fa-angle-right"></i> Grâce à l'agenda Communecté, rester informé est de plus en plus simple.</li>
			<!-- <li><i class="fa fa-angle-right"></i> Créez et partagez vos événements locaux.</li> -->
		</ul>
	</div>
	...
	<div class="explainOrganization explain hide">
		...
		<ul>
			...
			<li>Seul on va plus vite, ensemble on va plus loin.</li>
			<li>Chaque territoire et toutes les villes sont pleins de projets. En nous reliant à eux</li>
			<li>nous contribuons à en assurer la promotion. </li>
		</ul>
	</div>
	...
	<div class="explainCommune explain hide">
		...
		<ul>
			...
			<li>Evoluant constamment avec la technologie et les mouvements sociaux</li>
			<li>Les villes sont des organismes vivants faits de nombreuses couches, tout comme une forêt.</li>
			<li>Cependant les forêts ont trés peu d’impact sur la nature</li>
			<li>Nous devons évoluer vers une efficience naturelle réduisant l’impact de nos vies</li>
			<li>Tout en communiquant massivement et construisant intelligemment</li>
			<li>Devenir une commune adhérente !!  </li>
		</ul>
	</div>
	
	<div class="explainCommuneJoin explain hide">
		<h1 class="homestead text-dark">Devenir un Commune adhérente</h1>
		<ul>
	...
	<div class="explainConnect explain hide">
		...
		<ul>
			...
			<li><i class="fa fa-angle-right"></i> Participer à des <strong>événements</strong> ou des <strong>projets</strong></li>
	...
	<div class="explainRegister explain hide">
		...
		<ul>
			...
			<li><i class="fa fa-angle-right"></i> J'organise des <strong>événements</strong>, et je veux les faires connaître</li>
			<li><i class="fa fa-angle-right"></i> J'ai des <strong>projets</strong> à partager</li>
	...
	<div class="explainAssociatif explain hide">
		<h1 class="homestead yellowph">Associatif :</h1>
	...
	<div class="explainEconomie explain hide">
		<h1 class="homestead yellowph">Economie :</h1>
	...
	<div class="explainTerritoire explain hide">
		<h1 class="homestead yellowph">Territoire :</h1>
	...
	<div class="explainTourisme explain hide"> 
		<h1 class="homestead yellowph">Tourisme :</h1> 
	...
	<div class="explainAlimentation explain hide">
		<h1 class="homestead yellowph">Alimentation :</h1>
	...
	<div class="explainAgriculture explain hide">
		<h1 class="homestead yellowph">Agriculture :</h1>
	...
	<div class="explainCulture explain hide">
		<h1 class="homestead yellowph">Culture :</h1>
...
<li>Au sein de Communecter, ce sont les liens entre les entités qui donnent toutes la valeur au projet, c’est aussi grâce à ces liens que l’on estime la valeur par l’usage. Les liens que l’on a avec les acteurs locaux nous permettront de dresser un vrai annuaire démocratique</li>
	...
	<div class="explainProxicity explain hide">
		<h1 class="homestead yellowph">Proxicité</h1>
		<ul>
	...
	<div class="explainCodeLogiciel explain hide">
		<h1 class="homestead yellowph">Code Logiciel</h1>
		<ul>
	...
	<div class="explainConnectedTerritory explain hide">
		<h1 class="homestead yellowph">Territoire Connecté</h1>
		<ul>
	...
	<div class="explainLocalActors explain hide">
		<h1 class="homestead yellowph">Acteurs Locaux</h1>
		<ul>
	...
	<div class="explainCodeSocial explain hide">
		...
		<ul>
			...
			Les objectifs du code social sont multiples :
			<li>Permettre une prise en compte de la diversité des enjeux liés à la conception et au développement d'un projet ou d'une organisation.</li>
			<li>Permettre une description fine et exhaustive de leurs enjeux et de leurs principes de fonctionnement.</li>
			<li>Permettre aux organisations et aux projets d'être pleinement transparents.</li>
			<li>Tisser la confiance en permettant à tous d'avoir accès au code source d'une organisation ou d'un projet.</li>
			<li>Permettre le développement de collaborations saines et durables en évitant les imprécisions, les postures seulement rhétoriques, les non-dits, les malentendus, les surprises …</li>
			<li>Outiller, encourager, favoriser les organisations et les projets qui accordent une importance particulière à la transparence et à la cohérence de leur démarche.</li>
		</ul>
		<ul>
			Le code social comporte la raison d'être d'une organisation ou d'un projet ainsi que 7 modèles permettant de les décrire :
			<li>Raison d'être : Vision, missions, valeurs</li>
			<li>Modèle social et humain,</li>
			<li>Modèle économique,</li>
			<li>Modèle technologique</li>
			<li>Modèle juridique et financier</li>
			<li>Modèle écologique</li>
			<li>Modèle artistique et culturel</li>
		</ul>
	</div>
	...
	<div class="explainCommunecteur explain hide">
		...
		<ul>
			...
			<li> préparer plusieurs apéro citoyen (45min) pour présenter l'outil </li>
			<li> participer activement à relayer massivement la campagne de crowdfunding</li>
		</ul>
		<ul>
			Je suis communecteur quand je crois à :
			<li> un nouvel outil pour de nouveaux usages</li>
			<li> la valeur par l'usage et plus à celui d'un prix</li>
			<li> l'open-source et à l'open-data</li>
			<li> et qu'il est temps de changer de présentatrice météo et d'actu !!</li>
		</ul>
		<ul>
	...
	<div class="explainDeveloper explain hide">
		<h1 class="homestead yellowph">Developpeurs</h1>
		<ul>
	...
	<div class="explainDesigner explain hide">
		<h1 class="homestead yellowph">Designeurs et Artistes</h1>
		<ul>
	...
	<div class="explainContributor explain hide">
		...
		<ul>
			...
			N’hésitez pas si le projet vous intéresse et que vous avez de l’énergie à transmettre, elle sera utilisée pour le bien commun. Les contributions seront prises en compte à l’aide de matrices de richesses. Ce dispositif permettra de valoriser les contributions dont la communauté reconnait la valeur.
		</ul>
	</div>
	...
	<div class="explainODB explain hide">
		<h1 class="homestead yellowph"> ODB : Open dataBase</h1>
		<ul>
	...
	<div class="explainTransition explain hide">
			<h1 class="homestead yellowph">Transition</h1>
			<ul>
				<li>Récemment plusieurs gares ont vu plusieurs trains de la transition partir dans différentes directions.</li>
				<li>Pour chacun de ces trains le chemin est plus ou moins long...</li>
				<li>Le plus dur est de choisir comment on se place par rapport à tous ces trains :</li>
				<li>Etre simple spectateur qui regardera les trains passer ;</li>
				<li>Etre celui qui tente tout pour prendre le train en route ;</li>
				<li>Rester assis dans le train et se laisser porter ;</li>
				<li>Etre dans le train et courir pour atteindre le conducteur ;</li>
				<li>Etre un conducteur de train ;</li>
				<li>Passer d’un train à l’autre pour goûter à tout.</li>
				<li>Ce qui est sûr c’est qu’il y a du mouvement dans l’air, la transition est en cours...</li>
		</ul>
	</div>
