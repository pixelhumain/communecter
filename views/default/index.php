...
<div class="center text-white" id="menu-container" style="" >
    <div class="center text-white pull-left">
        ...
        <br/><br/><a href="#panel.box-add" onclick="showAjaxPanel( baseUrl+'/'+moduleId+'/city/detali/?isNotSV=1', 'MY CITY ','university' )" class="tooltips"  data-placement='right' data-original-title='MY CITY'><i class="fa fa-university fa-2x btn-main-menu"></i></a>
