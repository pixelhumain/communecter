          ...
          <?php
            if(Role::isSourceAdmin(Role::getRolesUserId(Yii::app()->session["userId"]))){
              ...
              foreach ($sourceAdmin as $key => $value) {
                ?>
                  <li><a href="javascript:;" onclick="loadByHash('#adminpublic.index?key=<?php echo $value ;?>');" id="btn-menu-dropdown-add"><i class="fa fa-cog text-blue"></i> <i class="fa fa-users text-green"></i> <?php echo $value ; ?></a></li>
                <?php
              }
            }
          ?>
