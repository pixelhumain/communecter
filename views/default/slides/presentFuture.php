...
<div class="panel-heading border-light center text-dark partition-white radius-10">
    <span class="panel-title homestead text-red"> <span style="font-size: 48px; "> PRESENT & FUTURE  ?</span></span>  
</div>
...
<div class="col-sm-12 ">
    ...
    <div class="panel panel-white ">
        <div class="panel-body">
            ...
            <ul class=" text-dark">
                  <li>6 devs plein temps</li>
                  <li>30 communecteurs en France </li>
                  <li>+3000 inscrits en 1moi 1/2 de beta tests, sans etre ouvert !!</li>
