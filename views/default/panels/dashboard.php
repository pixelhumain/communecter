      ...
      <div class="col-sm-6">
        <div class="panel core-box">
          ...
          <div class="panel-footer partition-white clearfix no-padding">
            ...
            <a title="Invite Someone" href="javascript:;" onclick="showAjaxPanel( '/person/invitesv?isNotSV=1', 'INVITE SOMEONE','share-alt' )" class="col-xs-4 padding-10 text-center text-yellow tooltips" data-toggle="tooltip" data-placement="top"><i class="fa fa-plus"></i></a>
      ...
      <div class="col-sm-6">
        <div class="panel panel-default panel-white core-box">
          ...
          <div class="panel-footer partition-white clearfix no-padding">
            ...
            <a title="Add An Organization" href="javascript:;" onclick="showAjaxPanel( '/organization/addorganizationform?isNotSV=1', 'ADD AN ORGANIZATION','users' )" class="col-xs-4 padding-10 text-center text-green tooltips" data-toggle="tooltip" data-placement="top"><i class="fa fa-plus"></i></a>
        ...
        <div class="panel panel-default panel-white core-box">
          ...
          <div class="panel-footer partition-white clearfix no-padding">
           <a title="My events" href="javascript:;" onclick="showAjaxPanel( '/person/directory/?tpl=directory2&type=<?php echo Event::COLLECTION ?>', 'EVENT DIRECTORY ','calendar' )" class="col-xs-4 padding-10 text-center text-orange tooltips" data-toggle="tooltip" data-placement="top"  ><i class="fa fa-bars"></i></a>
            <a title="Add An Event" href="javascript:;" onclick="showAjaxPanel( '/event/eventsv?isNotSV=1', 'ADD AN EVENT','calendar' )" class="col-xs-4 padding-10 text-center text-orange tooltips" data-toggle="tooltip" data-placement="top"><i class="fa fa-plus"></i></a>
      ...
      <div class="col-sm-6">
        <div class="panel panel-default panel-white core-box">
          ...
          <div class="panel-footer partition-white clearfix no-padding">
            ...
            <a title="Add A Project" href="javascript:;" onclick="showAjaxPanel( '/project/projectsv/id/<?php echo Yii::app()->session['userId']?>/type/citoyen?isNotSV=1', 'ADD A PROJECT','lightbulb-o' )" class="col-xs-4 padding-10 text-center text-purple tooltips" data-toggle="tooltip" data-placement="top"><i class="fa fa-plus"></i></a>
