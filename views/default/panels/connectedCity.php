	...
	<section>
		<div class="partition-white padding-20 radius-10">
			...
			<div class="col-sm-6">
				...
				<a href="#person.detail.id.97411" class=" lbh text-red btn btn-xs btn-default">Naswell</a>
				<a href="#person.detail.id.97411" class=" lbh text-red btn btn-xs btn-default">L'art Chic</a> 
			</div>	</div>
	 lbh 	
	</section>
