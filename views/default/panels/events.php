<div class="box-event box">
	<h1 class="event text-orange"><i class="fa fa-calendar"></i> EVENTS</h1>
	<section>
	...
	<a href="#" class="homestead nextBtns text-purple pull-right" onclick="showPanel('box-projects')"><i class="fa fa-lightbulb-o"></i> PROJECTS <i class="fa fa-arrow-circle-right"></i></a>
</div>