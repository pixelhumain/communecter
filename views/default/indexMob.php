  ...
  <div class="col-md-6 col-lg-3 col-sm-6">
    <div class="panel panel-default panel-white core-box">
      ...
      <div class="panel-footer clearfix no-padding">
        ...
        <a href="javascript:getModal('assoForm', '/<?php echo $this->module->id?>/organization/form/type/association',null);" class="col-xs-4 padding-10 text-center text-white tooltips partition-blue" data-toggle="tooltip" data-placement="top" title="Ajouter une Association"><i class="fa fa-plus"></i></a>
