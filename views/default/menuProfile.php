<div class="dropdown pull-right hidden-xs">
  ...
  <ul class="dropdown-menu dropdown-menu-right">
    ...
    <li><a href="javascript:;" onclick="loadByHash('#news.index.type.citoyens.id.<?php echo Yii::app()->session['userId']?>.viewer.<?php echo Yii::app()->session['userId']?>');"         id="btn-menu-dropdown-my-news"><i class="fa fa-rss text-dark"></i> Mon fil d'actualité</a></li>
