...
<div class="col-md-8 col-md-offset-2">
	<h1>Add an Organization or a Person to my Network</h1>
    <p>An Organization can be linked to an other Organization or a Person</p>
	...
	<form id="addMemberForm" style="line-height:40px;">
        ...
        <div class="row">
            ...
            <select id="knowsType" name="knowsType">
                <option value="workWith">Work With</option>
                <option value="oldMember">Old member</option>
            </select>
	    </div>
	    <div class="row">
	        <button class="btn btn-primary">Add to my network</button>
	    </div>
    </form>
</div>
