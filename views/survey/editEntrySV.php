...
$idSurvey = @$_GET['survey'] ? $_GET['survey'] : null;
if($idSurvey == null) $idSurvey = @$surveyId ? $surveyId : null;
...
jQuery(document).ready(function() { toastr.success('ready');
...
function editEntrySV () { toastr.success('editEntrySV');
