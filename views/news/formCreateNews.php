...
<div id="newNote" style="display:block;">
	...
	#title_news{
		margin-bottom:5px;
		-moz-box-shadow: 0px 0px 8px 0px #656565 !important;
		-webkit-box-shadow: 0px 0px 8px 0px #656565 !important;
		-o-box-shadow: 0px 0px 8px 0px #656565 !important;
		box-shadow: 0px 0px 8px 0px #656565 !important;
		filter:progid:DXImageTransform.Microsoft.Shadow(color=#656565, Direction=NaN, Strength=8) !important;
	}
	#txt_news{
		margin-top:10px;
		min-height:420px;
	...
	.itemBtnSelectGenre{
		...
		margin:0px;
		margin-left:0px;
		border-radius:0px;--6px 6px 0px 0px;
		padding:4px;
	...
	.itemBtnSelectGenre:hover{
		-moz-box-shadow: 0px -4px 2px 0px #5BC0DE;
		-webkit-box-shadow: 0px -4px 2px 0px #5BC0DE;
		-o-box-shadow: 0px -4px 2px 0px #5BC0DE;
		box-shadow: 0px -4px 2px 0px #5BC0DE;
		filter:progid:DXImageTransform.Microsoft.Shadow(color=#5BC0DE, Direction=90, Strength=4);
	}
	#tooltip_genre_block{
		display:block;
		margin-top:10px;	
	...
	<div class="noteWrap col-md-6">
		<form novalidate="novalidate" class="form-note" id="form_new_article" style="margin-left:30px;">
...
<!-- 	TEXT EDIT		 -->
	...
	<div class="noteWrap col-md-6" style="max-width:350px; ">
<!-- 		<h4 style="max-width:350px;"><i class="fa fa-chevron-down"></i> Sélectionner les destinataires</h4>  -->
		<div class="panel panel-white" style="margin-top:70px;">
		...
		<div class="" style="max-width:350px; padding:10px; margin-bottom:35px;" id="config_dest">
			<div class="form-group">
				...
				<div style="text-align:left;">
					...
					<i class="fa fa-navicon"></i><b> Parmis vos contacts : </b></br>
			...
			<h4 style="max-width:350px;"><i class="fa fa-chevron-down"></i> De quoi parle votre message ?</h4> 
			<div class="" style="max-width:350px; padding:10px;" id="config_dest">
				<?php
					for($i=1;$i<21;$i++) //background-color:#5F8295;
					{
						...
						echo "<img src='".$this->module->assetsUrl."/images/news/themes/".$i.".png' height=29  title='".News::get_THEMES_NAMES($i)."' class='img_illu_publication_theme' id='".$i."'> ";
...
{ 
	...
	//for(var i=1;i<21;i++){
		//$("#about_"+i).tooltip({ content: "Awesome title!" });
	//}
	$( document ).tooltip();											
...
//formGenre.js
	...
	function showTooltipGenre(genre){
		...
		//var left = parseInt($("#itemSelectGenre" + genre).position().left.replace("px", "")) + 10;
		//alert($("#tooltip_genre_name").width());
		...
		$("#tooltip_genre_name").css({"left": left + "px"});
			...
			//alert(JSON.stringify(listGenre));
	...
	function checkChkAbout(i){
		...
		$("#hashtags_list_json").html(JSON.stringify(aboutList));
