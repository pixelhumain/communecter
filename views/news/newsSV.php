	    	  ...
	    	  dataType: "json"
	    		...
	    		if(data.result)
	    		{
	    			if( 'undefined' != typeof updateNews && typeof updateNews == "function" )
	            		...
	            		showAjaxPanel( baseUrl+'/'+moduleId+'/news/index/type/<?php echo (isset($_GET['type'])) ? $_GET['type'] : 'citoyens' ?>/id/<?php echo (isset($_GET['id'])) ? $_GET['id'] : Yii::app()->session['userId'] ?>', 'KESS KISS PASS ','rss' )
					console.dir(data);
					$.unblockUI();
					$("#ajaxSV").html('');
					$.hideSubview();
