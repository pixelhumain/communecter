...
/* ************ PARAMS DISPLAY ********************** */
$typeParams['city'] = array("libelle" => "Ville","class" => "City", "count" => 0, "tri" => 1);
...
{ 
	...
	{ 
		...
		$content .= buildNewsLine($e, News::CONTROLLER, $e['type'], $typeParams[$e['type']]['class']::ICON, $this->module->id,$tags,$scopes,$typeParams);
	};
}
/* ************ COMMENTS ********************** */
if(isset($comments)) 
